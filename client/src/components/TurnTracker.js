...
function TurnTracker() {
    ...
    const sortedPlayerCharacters = updatedPlayerCharacters.sort((a, b) => b.initiative - a.initiative)
    const sortedNonPlayerCharacters = updatedNonPlayerCharacters.sort((a, b) => b.initiative - a.initiative)
